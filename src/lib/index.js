...
export const point_home = [
  { background: "#B2FFE5", text: "Innovative Solutions", border: "#00998C", bg_text: "#00998C", position: "top-30 left-10" },
  { background: "#C2FFC5", text: "Principal Engineering", border: "#1BA406", bg_text: "#1BA406", position: "top-90 left-30" },
  { background: "#E2B2FF", text: "Robotic Intelligence", border: "#6A00FF", bg_text: "#6A00FF", position: "bottom-30 left-15" },
  { background: "#FFC4B2", text: "Artificial Intelligence", border: "#FF0D00", bg_text: "#FF0D00", position: "top-60 right-5" },
  { background: "#FFCDF6", text: "Robotic Bootcamp", border: "#FF009D", bg_text: "#FF009D", position: "bottom-75 right-30" },
  { background: "#FFEEB2", text: "Integrated System", border: "#A48100", bg_text: "#A48100", position: "bottom-20 right-30" },
];

export const division_list = [
  {
    title: "Principal Engineering",
    description: "Fokus pada perancangan mekanik, desain 3D, dan manufaktur struktur robot yang kokoh dan efisien.",
    icon: "engineering",
    color: "from-[#00C4FF] to-[#5A94FF]",
    border: "#00C4FF",
  },
  {
  ...
  },
  {
    ...
    description:
      "Merancang sistem elektronik, PCB, dan embedded system yang menghubungkan hardware dengan software secara seamless.",
    icon: "system",
    color: "from-[#FFC4B2] to-[#FF0D00]",
    border: "#FFC4B2",
  },
];
...
export const footer_data = {
  address: ["Bengkel Robot", "Gedung I Lt. 4, Jl. Nakula 1 No.5-11,", "Pendrikan Kidul, Semarang Tengah,", "Jawa Tengah 50131"],

  contact: {
    phone: "+62 882-2645-7475",
    email: "dinusrobotic@gmail.com",
    contact_person: "Alif Mahendra",
  },
  socials: [
    { name: "Instagram", icon: "instagram", href: "https://www.instagram.com/dinus_robotic_club" },
    { name: "Youtube", icon: "youtube", href: "https://youtube.com/@dinusroboticclub2219?si=MO68v5jU--Kz2y-S" },
    { name: "Github", icon: "github", href: "https://github.com/Dinus-Robotic-Club" },
  ],
};
